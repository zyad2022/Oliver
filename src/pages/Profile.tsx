...
import { User, Mail, LogOut, Calendar, ShieldAlert } from 'lucide-react';
...
export function Profile({ user, onLogout, onNavigate }: ProfileProps) {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 w-full"
    >
      <div className="bg-white rounded-3xl p-8 border border-natural-border shadow-sm">
        <h1 className="text-3xl font-arabic font-medium text-natural-text mb-8 border-b border-natural-border pb-4">
          الملف الشخصي
        </h1>
