...
const faqs: FAQItem[] = [
  {
    ...
    answer: "يمكنك تقديم طلب عن طريق تصفح المجموعات، اختيار المنتج المناسب، إضافته إلى سلة المشتريات، ثم اتباع خطوات إتمام الدفع (Checkout) وإدخال بياناتك."
  },
  {
    question: "ما هي طرق الدفع المتاحة؟",
    answer: "نوفر حالياً خيارات متعددة للدفع تشمل الدفع عند الاستلام، والتحويل المباشر، بالإضافة إلى بعض خيارات المحافظ الإلكترونية المتوفرة في منطقتك."
  },
  {
  ...
  },
  {
    ...
    answer: "بمجرد تأكيد طلبك، سنرسل لك رسالة نصية أو بريداً إلكترونياً لمتابعة حالة الطلب."
  },
  {
  ...
  },
  {
    ...
    answer: "يمكن تعديل الطلب (مثل تغيير العنوان أو إضافة منتج) فقط في حال لم يتم تجهيز الطلب بعد. يرجى التواصل مع الدعم الفني بأسرع وقت ممكن."
  },
  {
    question: "ماذا أفعل إذا استلمت منتجًا تالفًا؟",
    answer: "نعتذر بشدة عن ذلك. يرجى تصوير المنتج التالف والتواصل معنا خلال 24 ساعة من استلامه، وسنقوم بترتيب عملية الاسترجاع وإرسال قطع بديلة لك مجاناً."
  },
  {
  ...
  },
  {
    ...
    answer: "يمكنك إلغاء الطلب قبل تجهيزه من خلال حسابك أو التواصل معنا. في حال تم التجهيز، سيتم تطبيق سياسة الاسترجاع العادية."
  },
  {
  ...
  return (
    ...
    >
      ...
      <PageTitle 
        ...
        description="كل ما تحتاجين لمعرفته عن تجربة التسوق في أوليفر وطرق الدفع."
